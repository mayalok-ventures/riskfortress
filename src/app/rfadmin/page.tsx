...
import { Shield, Lock, Eye, EyeOff, Key, LogOut, BarChart3, FileText } from 'lucide-react'
            ...
            <main>
                ...
                {activeTab === 'content' && (
                    <div className="flex items-center justify-center min-h-[60vh]">
                        <div className="p-8 rounded-2xl glass-morphism border border-gray-800 text-center max-w-md">
