            ...
            <div className="max-w-4xl mx-auto px-8">
                <article className="legal-document font-serif text-gray-900" style={{ fontFamily: 'Times New Roman, serif', fontSize: '12px', lineHeight: '1.6', textAlign: 'justify' }}>
                    ...
                    <section className="mb-8">
                        ...
                        <p className="mb-4">6.2. The arbitration shall be conducted by a sole arbitrator mutually agreed upon by the parties, or in the absence of such agreement within thirty (30) days, appointed by the Mumbai Centre for International Arbitration (MCIA). The seat and venue of arbitration shall be Mumbai, Maharashtra, India.</p>
                        ...
                        <p className="mb-4">6.6. Subject to the arbitration provisions above, the courts at Mumbai, Maharashtra shall have exclusive jurisdiction over any matters not subject to arbitration.</p>
                    </section>
