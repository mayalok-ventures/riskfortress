...
const advantages = [
    ...
    },
    {
        ...
        stat: 'Military-Grade Defense',
        color: 'from-purple-500 to-purple-700',
    },
    {
        icon: Users,
        title: 'Exclusive Client Focus',
        description: 'We only serve enterprise conglomerates and Ultra-HNWIs. No security guard contracts.',
        stat: 'Ultra-HNWI Focus',
...
const vsTraditional = [
    {
        aspect: 'Client Focus',
        riskfortress: 'Enterprise Conglomerates, HNIs, Family Offices',
            ...
            <div className="container relative z-10 mx-auto px-6">
                ...
                >
                    ...
                    <p className="text-xl text-gray-400 max-w-3xl mx-auto">
                        Why India&apos;s most discerning families and enterprises choose us for their most critical assets.
                    </p>
                </MotionDiv>
